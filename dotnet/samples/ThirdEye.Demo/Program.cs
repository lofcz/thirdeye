...
class Program
{
    static int Main(string[] args)
    {
        ...
        try
        {
            Console.WriteLine($"ThirdEye version: {ThirdEyeSession.GetVersion()}");
            Console.WriteLine();
            ...
            var defaultOptions = ThirdEyeSession.GetDefaultOptions();
            ...
            using ThirdEyeSession session = new ThirdEyeSession();
            ...
            session.CaptureToFile(defaultOutput);
            ...
            var bufferData = session.CaptureToBuffer();
